...
// queries
$selectStationeryCourses = "SELECT id, name, description FROM courses WHERE type='Stacjonarny'";
$selectOnlineCourses = "SELECT id, name, description FROM courses WHERE type='Online'";
...
while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
    $course = new Course($row['id'], $row['name'], $row['description']);
